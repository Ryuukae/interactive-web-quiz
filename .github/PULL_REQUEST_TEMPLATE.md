...
- [ ] `style`: CSS styling or code formatting modifications
- [ ] `test`: Added or updated unit, integration, or E2E tests
...
- [ ] `build`: Build system or bundler configuration changes
